    ...
    public partial class MainForm : Form
    {
        ...
        private void startStopBTN_Click(object sender, EventArgs e)
        {
            if (startStopBTN.Text.Equals("Start"))
            {
                ...
                ShowPattern(pattern, (int)repeatsUD.Value, continiousCB.Checked);
            }
            else
            {
        ...
        public void ShowPattern(int pattern, int repeat, bool continious = false)
        {
            SetKeys(000);
            for (int i = 0; i < repeat || continious; i++)
